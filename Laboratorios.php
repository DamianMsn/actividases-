...
<head>
    ...
    <title>Laboratorios | Cherry Tree</title>
</head>
<body>
    <div class="container">
        <div class="row mt-2">
        ...
        <div class="row mt-3">
            <h2 class="display-6 text-center">Registro de laboratorioos</h2>
        </div>
    </div>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method ="Post">
               <div class="row d-flex justify-content-center">
                     <div class="col-sm-12 col-md-12 col-lg-12">
                        <input type="text" name="NombreLaboratorio" id="NombreLaboratorio" Placeholder="Nombre del Laboratorio" class="form-control">
                     </div>
               </div>
               <div class="row mt-2">
                <div class="col-sm-12 col-md-6 col-lg-6 mt-2">
                    <select name="NombrePlantel" id="NombrePlantel" class="form-select">
